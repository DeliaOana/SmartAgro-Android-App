...
public class MQTTSubscribeFragment extends Fragment {
    ...
    public String                       topicToSubscribe = "smartagro";
    ...
    public MQTTPublishFragment.PublishDataPassListener pCallback;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof Activity){
            ...
            try {
                pCallback = (MQTTPublishFragment.PublishDataPassListener) activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fabSetari    = (Button) rootView.findViewById(R.id.fabSetari);
        ...
        fabSetari    .setOnClickListener(onClickListenerMQTT);
        ...
        public void onClick(final View v) {
            ...
            switch(v.getId()){
                ...
                case R.id.fabPublicare:
                    textToPublish = "udarePlante";
                    topicToPublish = "smartagro/comenzi";
                    qos = "1";
